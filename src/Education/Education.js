    ...
    const education = [
        {
            ...
            description: 'Relevant Coursework: React, Node.js, Python, Database Management, UI/UX',
        },
        {
            ...
            description: 'Learned programming, data structures, and software engineering.',
        },
    ];
